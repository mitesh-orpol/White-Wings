      ...
      <div className="product-details-page">
        ...
        <div className="container">
          ...
          <div className="show_page">
            <Link>Products</Link> <i class="fa-solid fa-angle-right"></i> <Link to="/casementDoor">Casement Doors </Link> <i class="fa-solid fa-angle-right"></i> <Link>67IW-IWL-ID  </Link>
          </div>
        </div>
      </div>
        ...
        <div className="container">
            <div className="row">
                <div className="col-lg-6">
                    ...
                    <h6 className="roboto">Casement Doors</h6>
