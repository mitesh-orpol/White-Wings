    ...
    <>
      <div className="product-page">
        ...
        <div className="container">
          <h1 className="playfair">UPVC Doors</h1>
        </div>
      </div>

      <div className="main-product">
        <div className="container">
          <h1 className="roboto">UPVC Doors</h1>
          <p className="roboto">
            Being the best among uPVC Doors manufacturers in the country, White
          ...
          <div className="all-product">
            <div className="row">
              <div className="col-lg-4 mb-5">
                <Link to="/UpvccasementDoor" onClick={scrollToTop}>
                  <div class="card">
                    <div className="wind-imd">
                      <img
                        src="./images/door/UpvcDoor1.png"
                        class="card-img-top"
                        alt="..."
                      />
                    </div>
              ...
              <div className="col-lg-4 mb-5">
                <Link to="/UpvcfoldDoor" onClick={scrollToTop}>
                  <div class="card">
                    <div className="wind-imd">
                      <img
              ...
              <div className="col-lg-4 mb-5">
                <Link to="/UpvcslidingDoor" onClick={scrollToTop}>
                  <div class="card">
                    <div className="wind-imd">
                      <img
                        src="./images/door/UpvcDoor3.png"
                        class="card-img-top"
                        alt="..."
                      />
                    </div>
            ...
            <div className="row">
              <div className="col-lg-4 mb-5">
                <Link to="/UpvcliftDoor" onClick={scrollToTop}>
                  <div class="card">
                    <div className="wind-imd">
                      <img
                        src="./images/door/UpvcDoor4.png"
                        class="card-img-top"
                        alt="..."
                      />
                    </div>
              ...
              <div className="col-lg-4 mb-5">
                <Link to="/UpvctiltDoor" onClick={scrollToTop}>
                  <div class="card">
                    <div className="wind-imd">
                      <img
                        src="./images/door/UpvcDoor5.png"
                        class="card-img-top"
                        alt="..."
                      />
                    </div>
