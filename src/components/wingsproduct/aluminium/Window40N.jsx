      ...
      <div className="product-details-page">
        ...
        <div className="container">
          ...
          <div className="show_page">
            <Link>Products</Link> <i class="fa-solid fa-angle-right"></i> <Link to="/aluminium/casementalu">Casement Windows & Door </Link> <i class="fa-solid fa-angle-right"></i> <Link>40N</Link>
          </div>
        </div>
      </div>
      ...
      <div className="window-cata">
        <div className="container">
            ...
            <div className="system_img">
              <div className="container">
                <img className="img-fluid" src="../../images/aliminiumdetails/casement-40n.png" alt="" />
              </div>
            </div>
