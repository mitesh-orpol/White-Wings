    ...
    <>
      <div className="product-page">
        ...
        <div className="container">
          <h1 className="playfair">UPVC Windows</h1>
        </div>
      </div>

      <div className="main-product">
        <div className="container">
          <h1 className="roboto">UPVC Windows</h1>
          <p className="roboto">
            Being the best among uPVC windows manufacturers in the country,
          ...
          <div className="small-image-pr">
            <div className="row">
              ...
              <div className="col-lg-2">
                <div className="box">
                  <img src="./images/product/sm1.png" alt="" />
                </div>
              ...
              <div className="col-lg-2">
                ...
                <h6 className="roboto">Sliding Window</h6>
              </div>
              <div className="col-lg-2">
                <div className="box">
          ...
          <div className="all-product">
            <div className="row">
              <div className="col-lg-4 mb-5">
                <Link to="/details" onClick={scrollToTop}>
                  <div class="card">
                    <div className="wind-imd">
                      <img
                        src="./images/product/w-10.png"
                        class="card-img-top"
                        alt="..."
                      />
                    </div>
              ...
              <div className="col-lg-4 mb-5">
                <Link to="/sliding" onClick={scrollToTop}>
                  <div class="card">
                    <div className="wind-imd">
                      <img
              ...
              <div className="col-lg-4 mb-5">
                <Link to="/twinsash" onClick={scrollToTop}>
                  <div class="card">
                    <div className="wind-imd">
                      <img
                        src="./images/product/w-7.png"
                        class="card-img-top"
                        alt="..."
                      />
                    </div>
            ...
            <div className="row">
              <div className="col-lg-4 mb-5">
                <Link to="/vertical" onClick={scrollToTop}>
                  <div class="card">
                    <div className="wind-imd">
                      <img
                        src="./images/product/w-12.png"
                        class="card-img-top"
                        alt="..."
                      />
                    </div>
              ...
              <div className="col-lg-4 mb-5">
                <Link to="/tilt" onClick={scrollToTop}>
                  <div class="card">
                    <div className="wind-imd">
                      <img
                        src="./images/product/w-13.png"
                        class="card-img-top"
                        alt="..."
                      />
                    </div>
