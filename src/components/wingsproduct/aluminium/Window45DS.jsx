      ...
      <div className="product-details-page">
        ...
        <div className="container">
          ...
          <div className="show_page">
            <Link>Products</Link> <i class="fa-solid fa-angle-right"></i> <Link to="/aluminium/casementalu">Casement Windows & Doors </Link> <i class="fa-solid fa-angle-right"></i> <Link>45DS</Link>
          </div>
        </div>
      </div>
        ...
        <div className="container">
            <div className="row">
                <div className="col-lg-6">
                    ...
                    <h6 className="roboto">Casement Windows & Doors</h6>
            ...
            <div className="system_img">
              <div className="container">
                <img className="img-fluid" src="../../images/aliminiumdetails/casement-45ds.png" alt="" />
              </div>
            </div>
