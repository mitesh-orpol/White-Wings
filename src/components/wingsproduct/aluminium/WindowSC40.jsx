      ...
      <div className="product-details-page">
        ...
        <div className="container">
          ...
          <div className="show_page">
            <Link>Products</Link> <i class="fa-solid fa-angle-right"></i> <Link to="/aluminium/slidingalu"> Sliding Window & Door</Link> <i class="fa-solid fa-angle-right"></i> <Link>SC40</Link>
          </div>
        </div>
      </div>
      ...
      <div className="window-cata">
        <div className="container">
            ...
            <div className="system_img">
              <div className="container">
                <img className="img-fluid" src="../../images/aliminiumdetails/6-sc40.png" alt="" />
              </div>
            </div>
