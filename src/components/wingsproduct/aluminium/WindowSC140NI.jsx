    ...
    <>
      <div className="product-details-page">
        ...
        <div className="container">
          <h1 className="">SC140NI </h1>
          <div className="show_page">
            <Link>Products</Link> <i class="fa-solid fa-angle-right"></i> <Link to="/aluminium/slidingalu"> Sliding Window & Doors </Link> <i class="fa-solid fa-angle-right"></i> <Link>SC140NI</Link>
          </div>
        </div>
      </div>
        ...
        <div className="container">
            <div className="row">
                <div className="col-lg-6">
                    ...
                    <h6 className="roboto"> Sliding Doors</h6>
                    <div className="custom-hr">
                        <hr />
                    </div>
                    <h1 className="roboto">SC140NI</h1>
                    <h3 className="roboto">Description:</h3>
                    <p  className="roboto">The SC140 is a 140 mm non-thermally broken sliding system for windows and doors, also suitable for the realization of lift and slide solutions.</p>
                ...
                <div className="col-lg-6">
                <img className="img-fluid" src="../../images/aliminiumdetails/sc140ni.jpg" alt="" />
                </div>
            </div>
            ...
            <div className="system_img">
              <div className="container">
                <img className="img-fluid" src="../../images/aliminiumdetails/2-sc140.png" alt="" />
              </div>
            </div>
            ...
            <div className="over_view">
                <div className="row">
                    <div className="col-lg-6">
                        ...
                        <li className="roboto">Maximum load : 300 kg/sash (up to 400 kg/sash with additional trolley) lift & Slide, 250 kg/sash Slide only. </li>
                        <li className="roboto">Glass thickness : 10 mm to 40 mm </li>
