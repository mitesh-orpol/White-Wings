    ...
    <>
      <div className="product-details-page">
        ...
        <div className="container">
          <h1 className="playfair">UPVC Casement Windows & Doors </h1>
        </div>
      </div>
      ...
      <div className="cash-me-windo">
        <div className="container">
          <h2 className="roboto">UPVC Casement Windows & Doors</h2>
          <p className="roboto">
            Casement windows & Doors have gained significant popularity in both private
          ...
          <div className="investa">
            <h2 className="roboto">Inventa Series uPVC Casement Windows & Doors</h2>
          ...
          <div className="investa">
            <h2 className="roboto">Optima Series uPVC Casement Windows & Doors</h2>
            <div className="row mt-5">
              <div className="col-lg-4">
                <img className="img-fluid" src="../images/productdetails/upvccasment.png" alt="" />
              </div>
