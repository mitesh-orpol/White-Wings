    ...
    <>
      <div className="product-details-page">
        ...
        <div className="container">
          <h1 className="">SC95TT </h1>
          <div className="show_page">
            <Link>Products</Link> <i class="fa-solid fa-angle-right"></i> <Link to="/aluminium/slidingalu"> Sliding Window & Doors</Link> <i class="fa-solid fa-angle-right"></i> <Link>SC95TT</Link>
          </div>
        </div>
      </div>
        ...
        <div className="container">
            <div className="row">
                <div className="col-lg-6">
                    ...
                    <h1 className="roboto">SC95TT</h1>
                    <h3 className="roboto">Description:</h3>
                    <p  className="roboto">The SC95TT is a 95 mm, thermally broken sliding system for windows and doors also is a superior, high-performance sliding solution with aesthetics and design appeal.</p>
                    
                    
                </div>
                <div className="col-lg-6">
                <img className="img-fluid" src="../../images/aliminiumdetails/sc95tt.jpg" alt="" />
                </div>
            </div>
            ...
            <div className="over_view">
                <div className="row">
                    <div className="col-lg-6">
                        ...
                        <li className="roboto">Glass thickness : 8 mm to 24 mm</li>
