    ...
    <>
      <div className="product-details-page">
        ...
        <div className="container">
          <h1 className="">SC95 </h1>
          <div className="show_page">
            <Link>Products</Link> <i class="fa-solid fa-angle-right"></i> <Link to="/slidingDoor"> Sliding Door </Link> <i class="fa-solid fa-angle-right"></i> <Link>SC95</Link>
          </div>
        </div>
      </div>
