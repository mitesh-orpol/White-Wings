    ...
    <>
      <div className="product-details-page">
        ...
        <div className="container">
          <h1 className="playfair">UPVC Casement Door</h1>
        </div>
      </div>
      ...
      <div className="cash-me-windo">
        <div className="container">
          <h2 className="roboto">UPVC Casement Door</h2>
          <p className="roboto">
          ...
          <div className="row">
            ...
            <div className="col-lg-5">
              <div className="main-details-img">
                <img
                  src="../images/UPVCDoor/UPVC Casement door.png"
                  alt=""
                />
              </div>
            </div>
          ...
          <div className="investa">
            <h2 className="roboto">Inventa Series uPVC Casement Doors</h2>
            <div className="row mt-5">
              <div className="col-lg-4">
                <img className="img-fluid" src="../images/productdetails/upvccasment.png" alt="" />
              </div>
              <div className="col-lg-8">
                <p className="roboto">venta Casement uPVC Doors provide for inside and outside opening doors to be used based on space availability. It can be a great choice of internal doors as well balcony doors. Since application of upvc door is for dust and weather proof , it is advisable to not use it as swing doors.</p>
          ...
          <div className="img-gallery">
            ...
            <div className="slider-container">
              <Slider {...settings}>
                <div>
                  <img
                    src="../images/UPVCDoor/UPVC Casement door1.png"
                    alt=""
                  />
                </div>
                <div>
                  <img
                    src="../images/UPVCDoor/UPVC Casement door2.png"
                    alt=""
                  />
                </div>
                <div>
                  <img
                    src="../images/UPVCDoor/UPVC Casement door3.png"
                    alt=""
                  />
                </div>
                <div>
                  <img
                    src="../images/UPVCDoor/UPVC Casement door4.png"
                    alt=""
                  />
                </div>
                <div>
                  <img
                    src="../images/UPVCDoor/UPVC Casement door5.png"
                    alt=""
                  />
                </div>
                <div>
...
export default UpvcCasementDoor;
