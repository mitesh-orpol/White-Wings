      ...
      <div className="product-details-page">
        ...
        <div className="container">
          ...
          <div className="show_page">
            <Link>Products</Link> <i class="fa-solid fa-angle-right"></i> <Link to="/aluminium/slidingalu"> Sliding Window & Doors </Link> <i class="fa-solid fa-angle-right"></i> <Link>INFINEO - S146LM</Link>
          </div>
        </div>
      </div>
      ...
      <div className="window-cata">
        <div className="container">
            ...
            <div className="system_img">
              <div className="container">
                <img className="img-fluid" src="../../images/aliminiumdetails/1-s146.png" alt="" />
              </div>
            </div>
