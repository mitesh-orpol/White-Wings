      ...
      <div className="product-details-page">
        ...
        <div className="container">
          ...
          <div className="show_page">
            <Link>Products</Link> <i class="fa-solid fa-angle-right"></i> <Link to="/aluminium/slidingalu"> Sliding Window & Doors</Link> <i class="fa-solid fa-angle-right"></i> <Link>SC45</Link>
          </div>
        </div>
      </div>
      ...
      <div className="window-cata">
        <div className="container">
            ...
            <div className="system_img">
              <div className="container">
                <img className="img-fluid" src="../../images/aliminiumdetails/5-sc45.png" alt="" />
              </div>
            </div>
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-3">
              <div className="von">
                <Link hretof="/contact" onClick={scrollToTop} className="roboto">
                  Contact Us
                </Link>
              </div>
            </div>
